                            ...
                            <div className="header-top">
                                <div className="header-top-left">
                                    <ul className="header-info">
                                        <li><a href="tel:+011235641231"><i className="icon-phone"></i>Liên hệ ngay: 0123 456 789</a></li>
                                ...
                                <div className="header-top-right">
                                    <ul className="header-info">
                                        ...
                                        <li><Link href="/sign-in"><a>Đăng ký</a></Link></li>
                        ...
                        <div className="header-navbar">
                            <div className="header-brand">
                                <div className="logo">
                                    <Link href="/">
                                        <a>
                                            <img className="logo-light" src={style_3 ? '/assets/images/logo/logo-masaru-original-dark.png' : '/assets/images/logo/logo-masaru-original-dark.png'} alt="Corporate Logo" />
                                            <img className="logo-dark" src={style_3 ? '/assets/images/logo/logo-masaru-original-light.png' : '/assets/images/logo/logo-masaru-original-light.png'} alt="Corporate Logo" />
                                        </a>
                                    </Link>
                                </div>
                            </div>
