    ...
    <div className="edublink-header-mini-cart">
      {cartItems.length === 0 && (
        <div className="wrapper empty-cart-wrapper">
          <h5 className="empty-cart">Giỏ hàng đang trống</h5>
        </div>
      )}
      {cartItems.length >= 1 && (
        <div className="wrapper">
          ...
          <div className="cart-checkout-buttons">
            <Link href="/cart">
              <a className="edu-btn btn-small cart-btn">Xem giỏ hàng</a>
            </Link>

            <Link href="/checkout">
              <a className="edu-btn btn-small btn-secondary checkout-btn">
                Thanh toán
              </a>
            </Link>
          </div>
