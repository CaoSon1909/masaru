                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="inner text-center">
                                <p>Bản quyền {new Date().getFullYear()} <a href="https://masaruhr.vn" rel="noreferrer" target="_blank">thuộc về Masaru</a> Thiết kế bởi <a href="https://1.envato.market/YgGJbj" target="_blank" rel="noreferrer">Son Pham - Masaru</a></p>
                            </div>
                        </div>
                    </div>
                </div>
