  ...
  return (
    <div className="edu-course-sidebar">
      <div className="edu-course-widget widget-category">
        <div className="inner">
          <h5 className="widget-title">Lọc theo danh mục</h5>
      ...
      <div className="edu-course-widget widget-instructor">
        <div className="inner">
          <h5 className="widget-title">Địa điểm làm việc</h5>
      ...
      <div className="edu-course-widget widget-level">
        <div className="inner">
          <h5 className="widget-title">Cấp độ</h5>
      ...
      <div className="edu-course-widget widget-language">
        <div className="inner">
          <h5 className="widget-title">Ngôn ngữ</h5>
      ...
      <div className="edu-course-widget widget-rating">
        <h5 className="widget-title">Mức lương</h5>
      ...
      <div className="edu-course-widget widget-rating">
        <h5 className="widget-title mb-4">Xóa bộ lọc</h5>
        <button
