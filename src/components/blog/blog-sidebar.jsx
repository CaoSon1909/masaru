  ...
  return (
    <div className="edu-blog-sidebar">
      ...
      <div className="edu-blog-widget widget-action">
        <div className="inner">
          <h4 className="title">
            Nhiều đơn hàng vẫn đang tuyển <span>tại Masaru</span>
          </h4>
      ...
      <div className="edu-blog-widget widget-categories">
        <div className="inner">
          <h4 className="widget-title">Bài đã đăng</h4>
          <div className="content">
            <ul className="category-list">
              <li>
                <a href="#">
                  Tháng 11/2017 <span>(3)</span>
                </a>
              </li>
              <li>
                <a href="#">
                  Tháng 12/2018 <span>(7)</span>
                </a>
              </li>
              <li>
                <a href="#">
                  Tháng 01/2019 <span>(2)</span>
                </a>
              </li>
              <li>
                <a href="#">
                  Tháng 02/2020 <span>(1)</span>
                </a>
              </li>
              <li>
                <a href="#">
                  Tháng 03/2021 <span>(3)</span>
                </a>
              </li>
            </ul>
          </div>
