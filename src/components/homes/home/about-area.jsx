                  ...
                  <div className="inner">
                    ...
                    <div className="content">
                      ...
                      <span className="subtitle">
                        Học viên đã sang Nhật vào năm 2023
                      </span>
                    </div>
                  </div>
                </div>
            ...
            >
              <div className="about-content">
                <div className="section-title section-left">
                  ...
                  <h2 className="title">
                    Chúng tôi tự hào là đơn vị phái cử lao động{" "}
                  ...
                  <p>
                    Chúng tôi luôn đặt chất lượng và uy tín lên hàng đầu, cam
                    kết tạo mọi điều kiện tốt nhất cho người lao động có đầy đủ
                    kiến thức, kỹ năng, ngôn ngữ để sinh sống và làm việc tại
                    nước ngoài.{" "}
                  </p>
                </div>
