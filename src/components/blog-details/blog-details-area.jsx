          ...
          <div className="col-lg-8">
            <div className="blog-details-content">
              ...
              <p>
                ...
                nguồn nhân lực chất lượng phái cử qua Nhật Bản làm việc, lấy đó
                là cơ sở để kết nối doanh nghiệp & nâng cao mối quan hệ hữu nghị
                giữa hai nước Việt - Nhật
              </p>
              <ul>
            ...
            <div className="comment-form-area">
              <h3 className="heading-title">Để lại bình luận của bạn</h3>
              {/* form start */}
              <BlogCommentForm />
              {/* form end */}
            </div>
