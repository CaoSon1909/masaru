          ...
          <div className="row row--30">
            <div className="col-lg-8">
              <div className="details-content">
                ...
                <p>
                  Lấy giáo dục làm nền tảng, việc làm là định hướng để xây dựng
                  nguồn nhân lực chất lượng phái cử qua Nhật Bản làm việc, lấy
                  đó là cơ sở để kết nối doanh nghiệp & nâng cao mối quan hệ hữu
                  nghị giữa hai nước Việt - Nhật
                </p>
                <ul>
                  ...
                  <div className="inner">
                    <div className="content">
                      ...
                      <ul className="course-item">
                        ...
                        <li>
                          <span className="label">
                            <i className="icon-70"></i>Total Slot:
                          </span>
                          <span className="value">30</span>
                        </li>
                        <li>
                          <span className="label">
                            <i className="icon-68"></i>Booked Slot:
                          </span>
